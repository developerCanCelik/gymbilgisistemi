...
<style>#boxx
    ...
    <body class="page-body  page-fade" onload="collapseSidebar()">
       ...
       <form id="form1" name="form1" action="sifre_s_degistir.php" enctype="multipart/form-data" method="POST" class="a1-container" >
         ...
         <tr>
           <td height="35"><table width="100%" border="0" align="center">
             ...
             <tr>
               <td height="35"></td>
               <td height="35"><a href="sifre_degistir.php" class="a1-btn a1-blue">SUBMIT</a><!--<input class="a1-btn a1-blue" type="submit" name="submit" id="submit" value="SUBMIT" >-->
