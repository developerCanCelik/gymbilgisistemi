          ...
          if(mysqli_query($con,$query2)==1){
            ...
            if(mysqli_query($con,$query4)==1){
              ...
              if(mysqli_query($con,$query5)==1){
               echo "<head><script>alert('Üye Eklendi ');</script></head></html>";
               echo "<meta http-equiv='refresh' content='0; url=yeni_giris.php'>";
              }
              else{
                  echo "<head><script>alert('Üye Ekleme Başarısız');</script></head></html>";
